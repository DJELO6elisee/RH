...
// Routes pour la gestion des documents administratifs
    ...
    },
    {
        ...
        path: '/note-service',
        icon: 'MdNote',
        description: 'Gestion des notes de service',
        category: 'Gestions des documents administratifs'
    },
    {
        id: 'mutations',
...
export const routesByCategory = backendRoutes.reduce((acc, route) => {
    // Exclure la catégorie "Tableau de bord" pour le Super Admin afin
    // d'éviter qu'elle n'apparaisse dans la sidebar de gestion RH.
    // Les pages de tableau de bord restent accessibles via les autres layouts.
    if (route.category === 'Tableau de bord') {
        return acc;
    }
...
// Obtenir toutes les catégories uniques (sans "Tableau de bord")
