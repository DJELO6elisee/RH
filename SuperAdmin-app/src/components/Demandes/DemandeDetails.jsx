...
const DemandeDetails = ({ isOpen, toggle, demande, agentId, onValidationSuccess }) => {
    ...
    // Vérification de sécurité pour éviter les erreurs si demande est null
    // Note: Ce retour conditionnel est placé APRÈS tous les hooks pour respecter les règles des hooks React
    if (!demande) {
        return null;
    }
    ...
    const getNiveauEvolutionBadge = (niveau) => {
        const niveaux = {
            ...
            'valide_par_superieur': { color: 'success', text: 'Validé supérieur' },
            'valide_par_sous_directeur': { color: 'success', text: 'Validé sous-directeur' },
            'valide_par_directeur': { color: 'success', text: 'Validé directeur' },
            'valide_par_drh': { color: 'success', text: 'Validé DRH' },
            'valide_par_direction': { color: 'success', text: 'Validé direction' },
            'valide_par_dir_cabinet': { color: 'success', text: 'Validé Dir Cabinet' },
            'valide_par_chef_cabinet': { color: 'success', text: 'Validé Chef Cabinet' },
            'valide_par_directeur_central': { color: 'success', text: 'Validé Dir Central' },
            'valide_par_directeur_general': { color: 'success', text: 'Validé Dir Général' },
            'valide_par_ministre': { color: 'success', text: 'Validé ministre' },
    ...
    // Si c'est sa propre demande, ne pas afficher les boutons de validation
    if (isOwnDemand) {
        return (
    ...
    // Pour toutes les demandes qui nécessitent une validation (pas les propres demandes de l'agent)
    if (!isOwnDemand) {
