...
const DemandesList = ({ agentId, onDemandeClick, typeDemande = '' }) => {
    ...
    const getNiveauEvolutionBadge = (niveau, phase) => {
        const niveaux = {
            ...
            'valide_par_superieur': { color: 'success', text: 'Validé supérieur', style: { color: '#fff', fontWeight: 'bold' } },
            'valide_par_drh': { color: 'success', text: 'Validé DRH', style: { color: '#fff', fontWeight: 'bold' } },
            'valide_par_ministre': { color: 'success', text: 'Validé ministre', style: { color: '#fff', fontWeight: 'bold' } },
