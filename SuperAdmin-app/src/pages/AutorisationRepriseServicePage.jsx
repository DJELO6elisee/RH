...
const AutorisationRepriseServicePage = () => {
    const { user } = useAuth();
    ...
    return (
        <Page title="Autorisation de Reprise de Service" breadcrumbs={[{ name: 'Autorisation de Reprise de Service', active: true }]}>
            <Container fluid>
                <Row>
                    <Col>
                        {isDRH ? (
                            <DemandesDRHList
                                key={refreshKey}
                                typeDemande="certificat_reprise_service"
                                onDemandeClick={handleDemandeClick}
                            />
                        ) : (
                            <DemandesList typeDemande="certificat_reprise_service" />
                        )}
                    </Col>
                </Row>
            </Container>
...
export default AutorisationRepriseServicePage;
