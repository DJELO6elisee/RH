                                                ...
                                                <tr key={diplome.id || index}>
                                                    ...
                                                    <td>
                                                        {diplome.date_diplome 
                                                            ? (typeof diplome.date_diplome === 'number' && diplome.date_diplome >= 1900 && diplome.date_diplome <= 2100 ? String(diplome.date_diplome) : /^\d{4}$/.test(String(diplome.date_diplome)) ? String(diplome.date_diplome) : new Date(diplome.date_diplome).toLocaleDateString('fr-FR'))
                                                            : '-'}
                                                    </td>
                                                    <td>{diplome.ecole || '-'}</td>
                                                    <td>{diplome.ville || '-'}</td>
