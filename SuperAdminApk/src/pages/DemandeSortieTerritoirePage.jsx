...
const DemandeSortieTerritoirePage = () => {
    const { user } = useAuth();
    ...
    return (
        <Page title="Demande de Sortie du Territoire" breadcrumbs={[{ name: 'Demande de Sortie du Territoire', active: true }]}>
            <Container fluid>
                <Row>
                    <Col>
                        {isDRH ? (
                            <DemandesDRHList 
                                typeDemande="sortie_territoire" 
                                onDemandeClick={handleDemandeClick}
                            />
                        ) : (
                            <DemandesList typeDemande="sortie_territoire" />
                        )}
                    </Col>
                </Row>
            </Container>
...
export default DemandeSortieTerritoirePage;
