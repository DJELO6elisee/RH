...
const normalizeRoleCode = (roleNom) => {
  ...
  if (withUnderscore === 'responsable_cellule_de_passation' || withUnderscore === 'responsable_cellule_de_passation' || r.includes('passation')) return 'responsable_cellule_de_passation';
  if (['directeur', 'sous_directeur', 'sous-directeur', 'directeur_central', 'directeur_general', 'drh', 'super_admin', 'inspecteur_general', 'directeur_service_exterieur', 'chef_service', 'ministre', 'agent', 'admin_entite', 'responsable_cellule_de_passation', 'responsable_cellule_de_passation'].includes(r)) return r === 'sous-directeur' ? 'sous_directeur' : r;
