-- Migration: Ajouter les colonnes pour le fichier d'attestation d'adhésion à la table agents_associations
-- Date: 2025-01-XX
-- Description: Permet de joindre un fichier qui atteste qu'un agent appartient vraiment à une association

-- Ajouter les colonnes pour le fichier d'attestation
ALTER TABLE agents_associations 
...
SELECT 'Colonnes pour fichier d''attestation ajoutées avec succès à la table agents_associations' as message;
