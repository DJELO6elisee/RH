...
class DecisionCollectiveTemplate {

    static async generateHTML(decision, agents, validateur, annee = new Date().getFullYear()) {
        ...
        // Générer le tableau des agents
        let agentsRows = '';
        if (agents && agents.length > 0) {
            agentsRows = agents.map((agent, index) => {
        ...
        <head>
            ...
            <title>Décision de Congé Collective</title>
            <style>
                ${HEADER_CSS}
                body {
        ...
        <body>
            <div class="document-container">
                ...
                <div class="vu-list">
                    ...
                    <div class="vu-item"><div class="vu-label">Vu</div><div>le soit transmis ou les demandes formulées par les intéressé(e)s ;</div></div>
                </div>
 
                <div class="decide-title">DECIDE</div>
 
                <div class="article">
                    <span class="article-title">Article 1</span> : Un congé annuel de 30 jours consécutifs au titre de l'année ${annee} à solde de présence pour en jouir à leur frais, est accordé aux agents ci-dessous désignés en service à ${directionName}.
                </div>
                ...
                <div class="article">
                    <span class="article-title">Article 2</span> : A l'issue de leur congé, les intéressé(e)s reprendront service à leur poste.
                </div>
 
                <div class="article">
                    <span class="article-title">Article 3</span> : La présente décision de congé qui prendra effet pour compter de la date de cessation de service des intéressé(e)s sera enregistrée, communiquée et publiée partout où besoin sera.
                </div>
                ...
                <div class="footer-section">
                    <div class="ampliations">
                        ...
                        <div class="ampliation-item"><span>- Intéressé(e)s</span><span>${agents ? agents.length : 1}</span></div>
                        <div class="ampliation-item"><span>- Archives</span><span>1</span></div>
                        <div class="ampliation-item"><span>---</span></div>
                        <div class="ampliation-item"><span></span><span>${(agents ? agents.length : 1) + 5}</span></div>
                    </div>
...
module.exports = DecisionCollectiveTemplate;
