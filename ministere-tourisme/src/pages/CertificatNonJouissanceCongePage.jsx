...
const CertificatNonJouissanceCongePage = () => {
    const { user } = useAuth();
    ...
    return (
        <Page title="Demande de Certificat de non jouissance de congé" breadcrumbs={[{ name: 'Demande de Certificat de non jouissance de congé', active: true }]}>
            <Container fluid>
                <Row>
                    <Col>
                        {isDRH ? (
                            <DemandesDRHList
                                key={refreshKey}
                                typeDemande="certificat_non_jouissance_conge"
                                onDemandeClick={handleDemandeClick}
                            />
                        ) : (
                            <DemandesList typeDemande="certificat_non_jouissance_conge" />
                        )}
                    </Col>
                </Row>
            </Container>
...
export default CertificatNonJouissanceCongePage;
