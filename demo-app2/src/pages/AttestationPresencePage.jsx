...
const AttestationPresencePage = () => {
    ...
    return (
        <Page title="Attestation de Présence" breadcrumbs={[{ name: 'Attestation de Présence', active: true }]}>
            <Container fluid>
                <Row>
                    <Col>
                        {isDRH ? (
                            <DemandesDRHList 
                                typeDemande="attestation_presence" 
                                onDemandeClick={handleDemandeClick}
                            />
                        ) : (
                            <DemandesList typeDemande="attestation_presence" />
                        )}
                    </Col>
                </Row>
            </Container>
