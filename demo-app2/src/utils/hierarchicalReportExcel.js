 ...
 * Fiches complètes via agentMap si disponible ; sinon résumé API.
 */
...
/**
 * Plusieurs clés (dg_1, dg_2, …) peuvent partager le même libellé normalisé ; ne garder que la dernière
 * faisait pointer l'export MTL ordonné vers une DG « coquille » sans directions → tableau vide alors que le total ministère restait correct.
 */
